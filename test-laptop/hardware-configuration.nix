# I have modified this file! But it was generated by ‘nixos-generate-config’
{
  config,
  lib,
  pkgs, 
...

{
  ...
  boot.initrd = {
    ...
    luks.devices."crypt" = { # todo: work with yubikey or keyfile
      device = "/dev/disk/by-uuid/fa2d182b-df98-4484-a736-25f1b913a589";
  ...
  # Our boot device
  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/AD26-37E0";
    fsType = "vfat";
    options = [ 
